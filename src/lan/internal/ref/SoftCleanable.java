...
package lan.internal.ref;

import lan.internal.ref.CleanerImpl;
...
public abstract class SoftCleanable<T> extends SoftReference<T>
    ...
    public SoftCleanable(T referent, Cleaner cleaner) {
        super(Objects.requireNonNull(referent), lan.internal.ref.CleanerImpl.getCleanerImpl(cleaner).queue);
