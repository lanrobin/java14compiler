...
package com.lan.tools.sjavac.comp;
...
import com.lan.tools.javac.main.Main;
import com.lan.tools.javac.main.Main.Result;
import com.lan.tools.javac.util.Context;
import com.lan.tools.javac.util.Dependencies;
import com.lan.tools.javac.util.ListBuffer;
import com.lan.tools.sjavac.Log;
import com.lan.tools.sjavac.Util;
import com.lan.tools.sjavac.comp.dependencies.NewDependencyCollector;
import com.lan.tools.sjavac.comp.dependencies.PublicApiCollector;
import com.lan.tools.sjavac.server.CompilationSubResult;
import com.lan.tools.sjavac.server.SysInfo;
                ...
                if (explicitJFOs.size() > 0) {
                    ...
                    JavacTaskImpl task =
                            (JavacTaskImpl) compiler.getTask(new PrintWriter(stderrLog),
                                                             ...
                                                             explicitJFOs,
                                                             context);
                    sfm.setSymbolFileEnabled(!com.lan.tools.javac.util.Options.instance(context).isSet("ignore.symbol.file"));
