...
package com.lan.tools.sjavac.client;
...
public class SjavacClient implements Sjavac {
    ...
    // to point to a com.lan.tools.sjavac.Main that supports --startserver
    // for example by setting: sjavac=java%20-jar%20...javac.jar%com.lan.tools.sjavac.Main
