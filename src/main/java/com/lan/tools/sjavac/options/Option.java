...
package com.lan.tools.sjavac.options;
...
import com.lan.tools.sjavac.CopyFile;
 ...
 * option values, refer to com.lan.tools.sjavac.options.Options.
 *
...
public enum Option {
    ...
    TR("-tr", "Translate resources") {
        ...
        protected void processMatching(ArgumentIterator iter, OptionHelper helper) {
            ...
            //   .prop=com.lan.tools.javac.smart.CompileProperties
            //   .idl=com.lan.corba.CompileIdl
