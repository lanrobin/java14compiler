...
package com.lan.tools.javac.launcher;
...
import com.lan.tools.javac.resources.LauncherProperties.Errors;
...
public class Main {
    ...
    private static final String bundleName = "com.lan.tools.javac.resources.launcher";
