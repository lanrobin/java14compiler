...
public final class compiler extends java.util.ListResourceBundle {
    protected final Object[][] getContents() {
        return new Object[][] {
                ...
                { "compiler.err.first.statement.must.be.call.to.another.constructor", "constructor is not canonical, so its first statement must invoke another constructor" },
                ...
                { "compiler.err.is.preview", "{0} is an API that is part of a preview feature" },
                ...
                { "compiler.err.pattern.binding.may.not.be.assigned", "pattern binding {0} may not be assigned" },
                ...
                { "compiler.err.record.declaration.not.allowed.in.inner.classes", "record declarations not allowed in inner classes" },
                ...
                { "compiler.misc.canonical.constructor.must.be.public", "canonical constructor must be public" },
                ...
                { "compiler.misc.throws.clause.not.allowed.for.canonical.constructor", "throws clause not allowed for canonical constructor" },
                ...
                { "compiler.misc.type.must.be.identical.to.corresponding.record.component.type", "type must match that of the corresponding record component" },
                ...
                { "compiler.warn.is.preview", "{0} is an API that is part of a preview feature" },
