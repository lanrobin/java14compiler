...
import com.lan.tools.javac.api.BasicJavacTask;
import com.lan.tools.javac.file.CacheFSInfo;
...
import com.lan.tools.javac.main.CommandLine.UnmatchedQuote;
...
public class Main {
    ...
    public Result compile(String[] argv, Context context) {
        ...
        if (showClass != null) {
            if (showClass.equals("showClass")) // no value given for option
                showClass = "com.lan.tools.javac.Main";
            showClass(showClass);
        }
    ...
    public static final String javacBundleName =
        "com.lan.tools.javac.resources.javac";
}
