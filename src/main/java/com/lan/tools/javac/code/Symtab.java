...
import com.lan.tools.javac.code.Symbol.RootPackageSymbol;
import com.lan.tools.javac.code.Symbol.TypeSymbol;
import com.lan.tools.javac.code.Symbol.VarSymbol;
import com.lan.tools.javac.code.Type.BottomType;
import com.lan.tools.javac.code.Type.ClassType;
import com.lan.tools.javac.code.Type.ErrorType;
import com.lan.tools.javac.code.Type.JCPrimitiveType;
import com.lan.tools.javac.code.Type.JCVoidType;
import com.lan.tools.javac.code.Type.MethodType;
import com.lan.tools.javac.code.Type.UnknownType;
import com.lan.tools.javac.code.Types.UniqueType;
        ...
        unnamedModule = new ModuleSymbol(names.empty, null) {
                {
                    ...
                    com.lan.tools.javac.code.Directive.RequiresDirective d =
                            new com.lan.tools.javac.code.Directive.RequiresDirective(java_base,
                                    EnumSet.of(com.lan.tools.javac.code.Directive.RequiresFlag.MANDATED));
                    requires = List.of(d);
                }
                @Override
