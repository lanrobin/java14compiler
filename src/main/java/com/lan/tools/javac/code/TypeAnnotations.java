...
package com.lan.tools.javac.code;
...
import com.lan.tools.javac.code.Attribute.Array;
import com.lan.tools.javac.code.Attribute.TypeCompound;
...
import com.lan.tools.javac.code.Type.CapturedType;
import com.lan.tools.javac.code.Type.ClassType;
import com.lan.tools.javac.code.Type.ErrorType;
import com.lan.tools.javac.code.Type.ForAll;
import com.lan.tools.javac.code.Type.MethodType;
import com.lan.tools.javac.code.Type.PackageType;
import com.lan.tools.javac.code.Type.TypeVar;
import com.lan.tools.javac.code.Type.UndetVar;
import com.lan.tools.javac.code.Type.Visitor;
import com.lan.tools.javac.code.Type.WildcardType;
import com.lan.tools.javac.code.TypeAnnotationPosition.TypePathEntry;
import com.lan.tools.javac.code.TypeAnnotationPosition.TypePathEntryKind;
import com.lan.tools.javac.code.Symbol.VarSymbol;
import com.lan.tools.javac.code.Symbol.MethodSymbol;
import com.lan.tools.javac.code.Type.ModuleType;
import com.lan.tools.javac.code.TypeMetadata.Entry.Kind;
import com.lan.tools.javac.comp.Annotate;
...
public class TypeAnnotations {
    ...
    private class TypeAnnotationPositions extends TreeScanner {
        ...
        // {@link com.lan.tools.javac.parser.JavacParser.insertAnnotationsToMostInner(JCExpression, List<JCTypeAnnotation>, boolean)}
                ...
                final TypeAnnotationPosition pos)
        {
            ...
            if (type.hasTag(TypeTag.TYPEVAR)) {
                ...
                // UnionClassType uct = (com.lan.tools.javac.code.Type.UnionClassType)type;
                         ...
                         ListBuffer<TypePathEntry> location)
        {
            ...
            // com.lan.tools.javac.jvm.Gen.setTypeAnnotationPositions(int)
