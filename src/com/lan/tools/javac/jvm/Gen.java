...
import com.lan.tools.javac.tree.TreeInfo.PosKind;
...
import com.lan.tools.javac.jvm.Code.*;
import com.lan.tools.javac.jvm.Items.*;
...
import static com.lan.tools.javac.jvm.CRTFlags.*;
 ...
 *************************************************************************/
    ...
    private void setTypeAnnotationPositions(int treePos) {
        ...
        for (Symbol s : new com.lan.tools.javac.model.FilteredMemberList(clazz.members())) {
