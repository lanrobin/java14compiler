...
*/
// Code duplicated in com.lan.tools.classfile.TypeAnnotation.Position
public class TypeAnnotationPosition {
    ...
    // com.lan.tools.javac.jvm.Gen.genCatch, we first use this to hold
    // the catch type's constant pool entry index.  Then in
    // com.lan.tools.javac.jvm.Code.fillExceptionParameterPositions we
