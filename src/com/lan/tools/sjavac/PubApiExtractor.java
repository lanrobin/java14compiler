...
import com.lan.tools.sjavac.comp.PubapiVisitor;
import com.lan.tools.sjavac.comp.SmartFileManager;
import com.lan.tools.sjavac.options.Options;
import com.lan.tools.sjavac.pubapi.PubApi;
...
public class PubApiExtractor {
    ...
    public PubApiExtractor(Options options) {
        JavacTool compiler = com.lan.tools.javac.api.JavacTool.create();
        fileManager = new SmartFileManager(compiler.getStandardFileManager(null, null, null));
        context = new com.lan.tools.javac.util.Context();
