...
import com.lan.tools.javac.main.CommandLine;
import com.lan.tools.sjavac.Transformer;

/**
 * This class is used to decode sjavac options.
 * See com.lan.tools.sjavac.options.Options for example usage.
 *
    ...
    void traverse(String[] args) {
        ...
        while (argIter.hasNext()) {
            ...
            if (arg.startsWith("-")) {
                ...
                for (com.lan.tools.javac.main.Option javacOpt : com.lan.tools.javac.main.Option.values()) {
